...
exports.estimateCO2 = exports.populateSelectorsForContractFilter = exports.getTransactionsForContracts = void 0;
...
async function populateSelectorsForContractFilter(apiKey, contractFilter) {
    if (contractFilter.functions) {
        ...
        contractFilter.functions.forEach((func) => {
            ...
            if (func.indexOf("(") == -1) {
                ...
                contractFilter.selectors.add((0, keccak256_1.default)(func.replace(/ /g, "")).toString("hex").substring(0, 8));
            }
        });
            ...
            for (let i = 0; i < abi.length; ++i) {
                if (abi[i].type == "function" && functionsToLookUp.has(abi[i].name)) {
                    if (functionsToLookUp.get(abi[i].name) == undefined) {
                        ...
                        contractFilter.selectors.add((0, keccak256_1.default)(sig).toString("hex").substring(0, 8));
                    }
                    else {
