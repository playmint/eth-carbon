...
async function main() {
    ...
    const report = await (0, index_1.estimateCO2)("MYTE9PTHZD1R3HBSKZNTIM9BU34YEWZI5T", contracts);
    console.log((0, index_1.reportToString)(report, contracts));
    fs_1.default.writeFileSync("out.csv", (0, index_1.reportToCSV)(report, contracts));
}
main().catch((e) => {
    console.error(e);
});
